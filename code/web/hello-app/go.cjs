...
const abi = require('/Users/user/Desktop/blockchain/smart_contracts/code/solidity/hello/out/Hello.sol/Hello.json').abi;
...
const deployment = require('/Users/user/Desktop/blockchain/smart_contracts/code/solidity/hello/broadcast/Hello.s.sol/31337/run-latest.json');
